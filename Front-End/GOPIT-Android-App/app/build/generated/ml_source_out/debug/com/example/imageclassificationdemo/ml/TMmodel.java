...
public final class TMmodel {
  @NonNull
  private final Model model;

  private TMmodel(@NonNull Context context, @NonNull Model.Options options) throws IOException {
    model = Model.createModel(context, "TMmodel.tflite", options);
    MetadataExtractor extractor = new MetadataExtractor(model.getData());
  }

  @NonNull
  public static TMmodel newInstance(@NonNull Context context) throws IOException {
    return new TMmodel(context, (new Model.Options.Builder()).build());
  }

  @NonNull
  public static TMmodel newInstance(@NonNull Context context, @NonNull Model.Options options) throws
      IOException {
    return new TMmodel(context, options);
  }
