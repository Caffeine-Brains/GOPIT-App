...
/**
 * Identify the most prominent object in the image from a set of 6 categories. */
public final class GCModel {
  @NonNull
  ...
  private GCModel(@NonNull Context context, @NonNull Model.Options options) throws IOException {
    model = Model.createModel(context, "GCModel.tflite", options);
    ...
    TensorProcessor.Builder probabilityPostProcessorBuilder = new TensorProcessor.Builder()
      .add(new DequantizeOp((float)0, (float)1.0))
  ...
  @NonNull
  public static GCModel newInstance(@NonNull Context context) throws IOException {
    return new GCModel(context, (new Model.Options.Builder()).build());
  }

  @NonNull
  public static GCModel newInstance(@NonNull Context context, @NonNull Model.Options options) throws
      IOException {
    return new GCModel(context, options);
  }
